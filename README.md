...
**[nolmedo.dev](https://nolmedo.dev)** — Personal portfolio built with React & TypeScript
...
|---------|-------------|------|
| [◈ PixelPotion](https://github.com/nikolmedo/PixelPotion) | Raspberry Pi camera system that transforms photos into artistic styles (Pixar 3D, anime, watercolor, cyberpunk) at the press of a physical button. Powered by Google Gemini AI, delivered via Telegram. | `Python` `Raspberry Pi` `Gemini AI` `IoT` `Telegram API` |
...
© 2025 Nicolas Olmedo · Built with React & TypeScript
